...
<head>
    ...
    <style>
        ...
        .prose code { background: var(--dmg-dark); padding: .12em .4em;
                      font-size: .9em; }
        .prose pre { background: var(--dmg-dark); padding: 1rem 1.1rem;
        ...
        .prose blockquote { margin: 0 0 1rem; padding-left: 1rem;
                            border-left: 3px solid var(--dmg-dark); }
        ...
        .prose th, .prose td { text-align: left; padding: .45rem .7rem;
                               border-bottom: 1px solid var(--dmg-dark);
