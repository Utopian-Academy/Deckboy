...
(192.168.1.60), not the tunnel (10.2.0.2) and not loopback.
...
- **README overhauled.** It carried a "March 2025" banner, claimed 24 themes in
  ...
  /home/james/deckboy` and run Linux launcher scripts, described Window/Camera
...
### New
- **Test Bars pattern** — a testsrc2-style motion-diagnostics pattern (James
